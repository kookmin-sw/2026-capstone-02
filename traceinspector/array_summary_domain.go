...
func (domain ArraySummaryDomain[ElemDomain]) Clone() ArraySummaryDomain[ElemDomain] {
	return ArraySummaryDomain[ElemDomain]{val: domain.val, is_bot: domain.is_bot, is_top: domain.is_top}
}
...
func (arr ArraySummaryDomain[IntDomainImpl]) CreateTop() ArraySummaryDomain[IntDomainImpl] {
	return ArraySummaryDomain[IntDomainImpl]{val: arr.len.CreateTop(), len: arr.len.CreateTop(), is_top: true}
}

func (arr ArraySummaryDomain[IntDomainImpl]) CreateBot() ArraySummaryDomain[IntDomainImpl] {
	return ArraySummaryDomain[IntDomainImpl]{val: arr.len.CreateBot(), len: arr.len.CreateBot(), is_bot: true}
}
...
func (arr ArraySummaryDomain[IntDomainImpl]) From_AbstractValues(vals []AbstractValue[IntDomainImpl, ArraySummaryDomain[IntDomainImpl]]) ArraySummaryDomain[IntDomainImpl] {
	if len(vals) == 0 {
		...
		return ArraySummaryDomain[IntDomainImpl]{len: arr.Len().From_IntLitExpr(imp.IntLitExpr{Node: imp.Node{}, Value: 0}), val: arr.len.CreateBot()}
	}
	base := vals[0]
...
func (arr ArraySummaryDomain[IntDomainImpl]) Make_array(len_dom IntDomainImpl, default_value AbstractValue[IntDomainImpl, ArraySummaryDomain[IntDomainImpl]]) ArraySummaryDomain[IntDomainImpl] {
	return ArraySummaryDomain[IntDomainImpl]{val: default_value.Get_int()}
}

func (arr ArraySummaryDomain[IntDomainImpl]) SetVal(val AbstractValue[IntDomainImpl, ArraySummaryDomain[IntDomainImpl]]) ArraySummaryDomain[IntDomainImpl] {
	new_val, _ := arr.val.Join(val.Get_int())
	return ArraySummaryDomain[IntDomainImpl]{val: new_val}
}
